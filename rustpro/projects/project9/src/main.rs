...
fn make_money(some_str: &mut String){
    some_str.push_str("$$$");
}
...
fn main() {
    println!("Hello, understanding the string stuff!");
    let mut some_str = String::from("345");
    make_money(&mut some_str);

    println!("{}", some_str);

    let som="     something absoluter crap a.     ";
    println!("{} and {}",trim_and_capitalize(som), som);
